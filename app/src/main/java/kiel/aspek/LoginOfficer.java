...
public class LoginOfficer extends AppCompatActivity
{
...
/// Create Intent for SignUpActivity abd Start The Activity
    ...
    {
        final Dialog dialog = new Dialog(LoginOfficer.this);
...
// check if the Stored password matches with Password entered by user
               // if(password.equals(storedPassword))
                ...
                {
                    Toast.makeText(LoginOfficer.this, "User Name or Password does not match", Toast.LENGTH_LONG).show();
                }
            }
        });
